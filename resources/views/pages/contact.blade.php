...
<head>
<title>Sellpadi a Business Category Flat Bootstrap Responsive Website Template | Contact :: w3layouts</title>
	...
	<div class="contact main-grid-border">
		<div class="container">
			...
			<div class="upload">
						...
						<form id="upload" method="post" action="https://p.w3layouts.com/demos/17-02-2016/Sellpadi/web/upload.php" enctype="multipart/form-data">
			<div id="drop">
				<a>Choose file</a>
