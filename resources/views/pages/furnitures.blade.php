...
<head>
<title>Sellpadi a Business Category Flat Bootstrap Responsive Website Template | Furnitures :: w3layouts</title>
...
<script>
    ...
    <script src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/tabs.js"></script>
			...
			<div class="ads-grid">
				...
				<div class="range">
					<h3 class="sear-head">Price range</h3>
							...
							<!---->
							<script type="text/javascript" src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/jquery-ui.js"></script>
