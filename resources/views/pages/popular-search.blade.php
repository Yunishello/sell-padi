...
<head>
<title>Sellpadi a Business Category Flat Bootstrap Responsive Website Template | Popular-Search :: w3layouts</title>
...
<!--//fonts-->	
<!-- js -->
<script type="text/javascript" src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/jquery.min.js"></script>
<!-- js -->
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/bootstrap.min.js"></script>
<script src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/bootstrap-select.js"></script>
<script>
...
<script type="text/javascript" src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/jquery.leanModal.min.js"></script>
<link href="css/jquery.uls.css" rel="stylesheet"/>
<link href="css/jquery.uls.grid.css" rel="stylesheet"/>
<link href="css/jquery.uls.lcd.css" rel="stylesheet"/>
<!-- Source -->
<script src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/jquery.uls.data.js"></script>
<script src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/jquery.uls.data.utils.js"></script>
<script src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/jquery.uls.lcd.js"></script>
<script src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/jquery.uls.languagefilter.js"></script>
<script src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/jquery.uls.regionfilter.js"></script>
<script src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/jquery.uls.core.js"></script>
<script>
			$( document ).ready( function() {
				$( '.uls-trigger' ).uls( {
    ...
    <script src="<?php echo('/'); ?>/<?php echo('/'); ?>/js/easyResponsiveTabs.js"></script>
</head>
<body>
...
<script async src='../../../../<?php echo('/'); ?>/<?php echo('/'); ?>/js/autotrack.js'></script>
	...
	<div class="popular-search main-grid-border">
		<div class="container">
			<h2 class="head">Most popular search phrases</h2>
				<div class="tags">
					<p>
					<a class="tag1" href="/single">At vero eos</a>
					<a class="tag2" href="/single">doloremque</a>
					<a class="tag3" href="/single">On the other</a>
					<a class="tag4" href="/single">pain was</a>
					<a class="tag5" href="/single">rationally encounter</a>
					<a class="tag6" href="/single">praesentium voluptatum</a>
					<a class="tag7" href="/single">est, omnis</a>
					<a class="tag8" href="/single">who are so beguiled</a>
					<a class="tag9" href="/single">when nothing</a>
					<a class="tag10" href="/single">owing to the</a>
					<a class="tag11" href="/single">pains to avoid</a>
					<a class="tag12" href="/single">tempora incidunt</a>
					<a class="tag13" href="/single">pursues or desires</a>
					<a class="tag14" href="/single">Bonorum et</a>
					<a class="tag15" href="/single">written by Cicero</a>
					<a class="tag16" href="/single">Ipsum passage</a>
					<a class="tag17" href="/single">exercitationem ullam</a>
					<a class="tag18" href="/single">mistaken idea</a>
					<a class="tag19" href="/single">ducimus qui</a>
					<a class="tag20" href="/single">holds in these</a>
					</p>
				</div>
		</div>
		<!---728x90--->
		<div class="popular-regions">
			<div class="container">
				...
				<ul>
					<li><a href="/classified">Birmingham</a></li>
					<li><a href="/classified">Anchorage</a></li>
					<li><a href="/classified">Phoenix</a></li>
					<li><a href="/classified">Little Rock</a></li>
					<li><a href="/classified">Los Angeles</a></li>
					<li><a href="/classified">Denver</a></li>
					<li><a href="/classified">Bridgeport</a></li>
					<li><a href="/classified">Wilmington</a></li>
					<li><a href="/classified">Jacksonville</a></li>
					<li><a href="/classified">Atlanta</a></li>
					<li><a href="/classified">Honolulu</a></li>
					<li><a href="/classified">Boise</a></li>
					<li><a href="/classified">Chicago</a></li>
					<li><a href="/classified">Indianapolis</a></li>
					<div class="clearfix"></div>
				</ul>
			</div>
		</div>
		...
		<div class="popular-categories">
			<div class="container">
				...
				<div class="popular-category">
					<h4>Bikes</h4>
					<ul>
						<li><a href="/bikes">Bullet</a></li>
						<li><a href="/bikes">Royal enfield</a></li>
						<li><a href="/bikes">R15</a></li>
						<li><a href="/bikes">Fz</a></li>
						<li><a href="/bikes">Activa</a></li>
						<li><a href="/bikes">Pulsar</a></li>
						<li><a href="/bikes">Yamaha</a></li>
						<li><a href="/bikes">Mumbai</a></li>
						<li><a href="/bikes">Ktm</a></li>
						<li><a href="/bikes">Pulsar 220</a></li>
						<li><a href="/bikes">Bangalore</a></li>
						<li><a href="/bikes">Rx</a></li>
						<li><a href="/bikes">Pune</a></li>
						<li><a href="/bikes">Apache</a></li>
						<li><a href="/bikes">Harley davidson</a></li>
						<li><a href="/bikes">Delhi</a></li>
						<li><a href="/bikes">Kolkata</a></li>
						<li><a href="/bikes">Hyderabad</a></li>
						<li><a href="/bikes">Karizma</a></li>
						<li><a href="/bikes">Unicorn</a></li>
					</ul>
				</div>
				<div class="popular-category">
					<h4>Furniture</h4>
				...
				<div class="popular-category">
					<h4>Jobs</h4>
					<ul>
						<li><a href="/jobs">Driver</a></li>
						<li><a href="/jobs">Fresher</a></li>
						<li><a href="/jobs">Driver job</a></li>
						<li><a href="/jobs">Delivery boy</a></li>
						<li><a href="/jobs">Kolkata</a></li>
						<li><a href="/jobs">Part time</a></li>
						<li><a href="/jobs">Teacher</a></li>
						<li><a href="/jobs">Driver jobs</a></li>
						<li><a href="/jobs">Office boy</a></li>
						<li><a href="/jobs">Data entry</a></li>
						<li><a href="/jobs">Delhi</a></li>
						<li><a href="/jobs">Computer operator</a></li>
						<li><a href="/jobs">Data entry</a></li>
						<li><a href="/jobs">Graphic designer</a></li>
						<li><a href="/jobs">Receptionist</a></li>
						<li><a href="/jobs">Mumbai</a></li>
						<li><a href="/jobs">Part time job</a></li>
						<li><a href="/jobs">Work from home</a></li>
						<li><a href="/jobs">Accounting finance</a></li>
						<li><a href="/jobs">Cook</a></li>
						<li><a href="/jobs">Airport	</a></li>
					</ul>
				</div>	
				<div class="popular-category">
					<h4>Real Estate</h4>
