...
<head>
<title>Sellpadi a Business Category Flat Bootstrap Responsive Website Template | Register :: w3layouts</title>
...
<body><link rel="stylesheet" href="../../../../assests/{{asset('css/font-awesome.min.css')}}">
<!-- New toolbar-->
<style>
* {
	...
	<!-- Large modal -->
	 ...
	 <section>
		...
		<!--footer section start-->
			<footer class="diff">
			   <p class="text-center">&copy 2016 Sellpadi. All Rights Reserved | Design by <a href="pacifylabs.com" target="_blank">Pacifylabs</a></p>
			</footer>
        <!--footer section end-->
	</section>
