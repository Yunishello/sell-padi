...
<head>
<title>Sellpadi a Business Category Flat Bootstrap Responsive Website Template | Single :: w3layouts</title>
...
<script>
		...
		<link rel="stylesheet" href="{{asset('css/flexslider.css')}}" media="screen" />
</head>
<body>
...
<body><link rel="stylesheet" href="{{asset('assets/css/font-awesome.min.css')}}">
<!-- New toolbar-->
<style>
* {
	...
	<div class="single-page main-grid-border">
		<div class="container">
			<ol class="breadcrumb" style="margin-bottom: 5px;">
				<li><a href="/">Home</a></li>
				<li><a href="/classified">All Ads</a></li>
